...
var ASM_CONSTS = {
  1873168: ($0) => { _releaseCallback($0) },  
 1873193: ($0) => { return _callCallback($0).value ? 1 : 0; },  
 1873237: ($0) => { return _callCallback($0).value; },  
 1873273: ($0) => { return _callCallback($0).value; },  
 1873309: ($0) => { return _callCallback($0).value; },  
 1873345: ($0) => { _callCallback($0); }
};
