(function (root, factory) {
  ...
  var Companion_getInstance = kotlin_org_jetbrains_compose_ui_ui.$_$.n9;
  ...
  var Companion_getInstance_0 = kotlin_org_jetbrains_compose_ui_ui.$_$.o9;
  ...
  var Placeable = kotlin_org_jetbrains_compose_ui_ui.$_$.r3;
  ...
  var Companion_getInstance_5 = kotlin_org_jetbrains_compose_ui_ui.$_$.h9;
  ...
  var get_sign = kotlin_kotlin.$_$.ie;
  ...
  var coerceIn_0 = kotlin_kotlin.$_$.te;
  ...
  var InspectorValueInfo = kotlin_org_jetbrains_compose_ui_ui.$_$.v5;
  ...
  var ModifierLocalConsumer = kotlin_org_jetbrains_compose_ui_ui.$_$.g4;
  ...
  function offset_0(_this__u8e3s4, offset) {
    return _this__u8e3s4.then_g5qrxq_k$(new OffsetPxElement(offset, true, offset$lambda(offset)));
  }
  ...
  function OffsetPxNode$measure$lambda(this$0, $this_measure, $placeable) {
    return function ($this$layout) {
      ...
      if (this$0.rtlAware_1) {
        $this$layout.placeRelativeWithLayer$default_ge6w8k_k$($placeable, _IntOffset___get_x__impl__qiqr5o(offsetValue), _IntOffset___get_y__impl__2avpwj(offsetValue));
        tmp = Unit_getInstance();
      } else {
        $this$layout.placeWithLayer$default_hwuan4_k$($placeable, _IntOffset___get_x__impl__qiqr5o(offsetValue), _IntOffset___get_y__impl__2avpwj(offsetValue));
        tmp = Unit_getInstance();
      }
      return Unit_getInstance();
    };
  ...
  protoOf(OffsetPxNode).measure_z885gt_k$ = function (_this__u8e3s4, measurable, constraints) {
    ...
    return _this__u8e3s4.layout$default_n19e5l_k$(tmp, tmp_0, VOID, OffsetPxNode$measure$lambda(this, _this__u8e3s4, placeable));
  };
  function offset$lambda($offset) {
    return function ($this$$receiver) {
      $this$$receiver.set_name_wkmnld_k$('offset');
      $this$$receiver.get_properties_zhllqc_k$().set_vvveh5_k$('offset', $offset);
      return Unit_getInstance();
    };
  }
  ...
  function padding_0(_this__u8e3s4, paddingValues) {
    return _this__u8e3s4.then_g5qrxq_k$(new PaddingValuesElement(paddingValues, padding$lambda_0(paddingValues)));
  }
  ...
  function requiredSize_0(_this__u8e3s4, width, height) {
    ...
    var tmp0_inspectorInfo = tmp;
    return _this__u8e3s4.then_g5qrxq_k$(new SizeElement(width, height, width, height, false, tmp0_inspectorInfo));
  }
  function width$lambda($width) {
    return function ($this$null) {
      $this$null.set_name_wkmnld_k$('width');
      $this$null.set_value_rjqr2d_k$(new Dp($width));
      return Unit_getInstance();
    };
  }
  ...
  function requiredSize$lambda($width, $height) {
    return function ($this$null) {
      $this$null.set_name_wkmnld_k$('requiredSize');
